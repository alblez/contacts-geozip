<?php
/*
 * Author https://github.com/jeroendesloovere/distance
 * adaptado como Component de cakephp
 */
class DistanceComponent extends Component {
     ...
     * @param  string  $unit[optional]
     */
    public function getClosest($latitude1, $longitude1, $items, $decimals = 1, $unit = 'km') {
        // init result
        $distances = array();
